      ...
      <View style={styles.content}>
        {phase === 'request' ? (
          <>
            ...
            <TextInput value={email} onChangeText={setEmail} placeholder="you@example.com" style={styles.input} placeholderTextColor="#9CA3AF" />
...
export default AuthEmailOtpScreen;
