...
type SavedPostsScreenNavigationProp = NativeStackNavigationProp<ProfileStackParamList, 'SavedPostsScreen'>;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.postsCard}>
          ...
          <Text style={styles.postsContent}>Saved posts functionality coming soon!</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
